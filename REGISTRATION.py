...
firstw=Tk()
firstw.title("GALGOTIAS UNIVERSITY")
firstw.geometry("1600x1000+0+0")
label=Label(text="GALGOTIAS UNIVERSITY",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("GALGOTIAS UNIVERSITY")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="GALGOTIAS UNIVERSITY", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def root():
    ...
    root.title("GALGOTIAS UNIVERSITY")
    global entry1
    global entry2
    global entry3
    global entry4
